...
export const outputConfig = {
  errorsOG: { header: '', unit: '', label: 'Fehler OG', print: false, bold: false, border: '' },
  errorsBI: { header: '', unit: '', label: 'Fehler BI', print: false, bold: false, border: '' },
  duengeobergrenze: {
    header: 'Stickstoff',
    unit: 'kg/ha',
  ...
  vfwertzf: {
    header: '',
    unit: '',
    label: 'Vorfruchtwert Zwischenfrucht',
    print: true,
    bold: false,
    border: '',
  },
  nminman: { header: '', unit: '', label: 'Manueller N-Min', print: true, bold: false, border: '' },
  duengeobergrenzered: {
    label: 'Düngeobergrenze nach Abzügen',
    print: true,
    bold: true,
    border: 'bottom',
  },
  ...
  nmengewd: {
    header: '',
    unit: '',
    label: 'N aus Wirtschaftsdüngern',
    print: true,
    bold: false,
    border: '',
  },
  nabzug: {
    header: '',
    unit: '',
    label: 'N-Abzug von Düngeobergrenze',
    print: false,
    bold: false,
    border: '',
  },
  ...
  nbilanz: { header: '', unit: '', label: 'N-Bilanz', print: true, bold: true, border: 'bottom' },
  pbedarf: { header: '', unit: '', label: 'Phosphor-Bedarf', print: true, bold: false, border: '' },
  pmengehd: {
    header: '',
    unit: '',
    label: 'P aus Handelsdüngern',
    print: true,
    bold: false,
    border: '',
  },
  ...
  pmengewd: {
    header: '',
    unit: '',
    label: 'P aus Wirtschaftsdüngern',
    print: true,
    bold: false,
    border: '',
  },
  pduengung: {
    header: '',
    unit: '',
    label: 'Phosphordüngung (kg P₂O₅/ha)',
    print: true,
    bold: false,
    border: '',
  },
  ...
  kbedarf: { header: '', unit: '', label: 'Kalium-Bedarf', print: true, bold: false, border: '' },
  kmengehd: {
    header: '',
    unit: '',
    label: 'K aus Handelsdüngern',
    print: true,
    bold: false,
    border: '',
  },
  ...
  kmengewd: {
    header: '',
    unit: '',
    label: 'K aus Wirtschaftsdüngern',
    print: true,
    bold: false,
    border: '',
  },
  ...
  kentzug: {
    header: '',
    unit: '',
    label: 'Kaliumentzug gem. Ertrag (kg K₂O/ha)',
    print: true,
    bold: false,
    border: '',
  },
